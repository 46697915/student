...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/student?useUnicode=true&characterEncoding=utf8");
...
//        strategy.setInclude(new String[] { "student_info" }); // 需要生成的表
        ...
        pc.setParent("com.project.business.stud");
        ...
        //自定义 cope文件
        focList.add(new FileOutConfig("/templates/vue.html.ftl") {
            @Override
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return path + "/../resources/mapper/student/" + tableInfo.getEntityName() + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
