<template>
  ...
  <el-row>
    ...
    <el-table :data="listData" border style="width: 100%;"
      ...
      <el-table-column prop="name" label="菜单名"  width="100" ></el-table-column>
      <el-table-column prop="code" label="代码" width="55"></el-table-column>
      <el-table-column prop="pcode" label="上级代码" width="80"></el-table-column>
  ...
  export default {
    data() {
      return {
        listData: [],
        selectRows: [],
        queryUrl: this.domain.serverpath+"/sysMenu/listForPage",
        deleteUrl: this.domain.serverpath+"/sysMenu/deleteBatch",
