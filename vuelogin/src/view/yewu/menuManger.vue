   ...
   <div >
     ...
     <el-dialog
       ...
       <el-form ref="update" v-show="form2.form2show" :inline="true" v-model="form2" class="demo-form-inline">
         ...
         <br>
         <el-form-item label="当前菜单等级">
           <el-input v-model="form2.parentLeval" :style="{width:200+'px'}" :readonly="true"></el-input>
         </el-form-item>
         <el-form-item label="当前菜单ID">
           <el-input v-model="form2.parentId" :style="{'margin-left':14+'px',width:200+'px'}" :readonly="true"></el-input>
         </el-form-item>
         <el-form-item label="当前菜单名称">
           <el-input v-model="form2.menuName" :style="{width:200+'px'}" :readonly="true"></el-input>
         </el-form-item>
